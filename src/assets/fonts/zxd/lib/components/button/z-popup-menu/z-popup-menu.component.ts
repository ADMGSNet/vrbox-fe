...
import { ZPopupButtonComponent } from '@zxd/components/button/z-popup-button/z-popup-button.component';
...
import { ZPaginationStatusBarComponent } from '../../pagination/z-pagination-statusbar/z-pagination-statusbar.component';

@Component({
  selector: '',
  templateUrl: './z-popup-menu.component.html',
  styleUrl: './z-popup-menu.component.scss',
...
export class ZPopupMenuComponent<T extends Item> extends ZBaseComponent implements AfterViewInit {
  //************************************************************************//
  // consts
  //************************************************************************//
  ...
  private readonly Class = {
    Active: 'z_popup_menu_active',
    Button: 'z_popup_button',
    Down: 'z_popup_menu_down',
    Item: 'z_popup_menu_item',
    Opened: 'z_popup_menu_opened',
    Reverse: 'z_popup_menu_reverse',
    Selected: 'z_popup_menu_selected',
  };
   ...
   * Popup button
   */
  popupButton!: ZPopupButtonComponent<T>;

  /**
   * Whether the mouse button has been pressed or the touch has started
   */
  private down = false;
  ...
  private setPosition() {
    ...
    const body = this.popupButton.element.querySelector(`.${ this.Class.Button }`) as HTMLElement;
  ...
  constructor() {
    super();
    this.renderer.addClass(this.element, 'z-popup-menu');

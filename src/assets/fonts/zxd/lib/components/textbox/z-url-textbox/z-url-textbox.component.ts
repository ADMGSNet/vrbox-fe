...
@Component({
  selector: 'z-url-textbox',
  templateUrl: '../z-textbox-base/z-textbox-base.component.html',
  styleUrls: ['../z-textbox-base/z-textbox-base.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  providers: [{
    provide: NG_VALUE_ACCESSOR,
    multi: true,
    useExisting: forwardRef(() => ZUrlTextBoxComponent),
  }],
  standalone: true,
  imports: [
    // pipes
...
export class ZUrlTextBoxComponent extends ZTextBoxComponent {
  //************************************************************************//
  // properties
  //************************************************************************//
  /**
  ...
  private setPlaceHolder() {
    ...
    super.placeholder = labels.url_placeholder;
  }
  ...
  constructor() {
    ...
    this.type = ZTextBoxType.Url;
    this.iconName = ZIcon.World;
    this.setPlaceHolder();

    this.renderer.addClass(this.element, 'z-url-textbox');
  }
